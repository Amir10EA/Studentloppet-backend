...
public class UserControllerTest {
        ...
        public void testValidNameSet() throws Exception {
                mockMvc.perform(post("/studentloppet/set/user@example.com/Anders/Andersson")
        ...
        public void testInvalidFirstName() throws Exception {
                mockMvc.perform(post("/studentloppet/set/user@example.com/Anders123/Andersson")
                                .contentType(MediaType.APPLICATION_JSON))
        ...
        public void testInvalidLastName() throws Exception {
                mockMvc.perform(post("/studentloppet/set/user@example.com/Anders/Andersson123")
                                .contentType(MediaType.APPLICATION_JSON))
                                .andExpect(status().isBadRequest());
        }
